...
- (void)drawRect:(CGRect)rect
{
    ...
    [[UIColor colorWithWhite:0.3f alpha:0.7f] setFill];
    [roundedRect fill];
...
{
    if (animated) {
        // Setup initial state of the view before animation
        self.alpha = 0.0f;
        self.transform = CGAffineTransformMakeScale(1.3f, 1.3f);
        // Setup animation block
        [UIView animateWithDuration:0.3 animations:^{
            //Setup new state of the view after animation completes
            self.alpha = 1.0f;
